...
// Map of names and countries as many to one reducers
export const countryListSimpleMap = {
...
export const countryListSimple = [
  "Afghanistan",
  "Albania",
  "Algeria",
  "American Samoa",
...
export const findInternal = (source, list) => {
  for (const country of Object.keys(countryListSimpleMap)) {
...
export const find = source => {
  return findInternal(source, countryList);
}

export const findSimple = source => {
  return findInternal(source, countryListSimple);
}
